...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO CodeXTeam API!') // boleh diubah
}
...
loghandler = {
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: `Apikey tidak ditemukan! Silahkan kontak Owner untuk dapatkan Apikey wa.me/62857785356307`
    },
    invalidLink: {
        status: false,
        creator: `${creator}`,
...
// Api Features :
        ...
        var randomTextNumber = random+randomlagi+'---------kuhong-api-storage'+'CodeXTeam';
